...
const Contact = () => {
  const contactInfo = [
    ...
    },
    {
      icon: MapPin,
      title: "Endereço",
      content: siteConfig.address.formatted,
  ...
  const features = ["Atendimento presencial e online", "Orçamento personalizado"];
      ...
      <div className="container mx-auto px-4 lg:px-8">
        <div className="text-center space-y-6 mb-16">
          ...
          <p className="text-xl text-gray-secondary max-w-3xl mx-auto leading-relaxed">
            Estamos prontos para ouvir sua necessidade e oferecer a melhor solução
            jurídica para o seu caso em Guarulhos/SP e online.
          </p>
        </div>
        ...
        <div className="max-w-4xl mx-auto space-y-8">
          <div className="grid md:grid-cols-2 gap-6">
            {contactInfo.map((info) => (
              <Card
                key={info.title}
                className="p-6 border-gray-light hover:shadow-soft transition-all duration-300"
              >
                <div className="flex items-start gap-4">
                  ...
                  <div className="space-y-2 flex-1">
                    ...
                    {info.href ? (
                      ...
                      <p className="text-gray-primary whitespace-pre-line">{info.content}</p>
                    )}
                    {info.description && (
                      <p className="text-gray-secondary text-sm">{info.description}</p>
                    )}
                  </div>
                </div>
              </Card>
          ...
          <Card className="p-4 border-gray-light overflow-hidden">
            <div className="aspect-video bg-muted rounded-lg flex items-center justify-center">
              <div className="text-center space-y-2 px-4">
                ...
                <p className="text-gray-secondary">{siteConfig.address.formatted}</p>
                <a
                  href={siteConfig.googleMapsUrl}
                  target="_blank"
                  rel="noopener noreferrer"
