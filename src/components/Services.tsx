      ...
      <div className="container mx-auto px-4 lg:px-8">
        <div className="text-center space-y-6 mb-16">
          ...
          <p className="text-xl text-gray-secondary max-w-3xl mx-auto leading-relaxed">
            Oferecemos atendimento especializado em diversas áreas do Direito Civil e
            do Consumidor, sempre com foco na resolução eficaz dos seus problemas jurídicos.
          </p>

          <div className="flex flex-wrap justify-center gap-3 pt-2">
            <Link
              to="/direito-civil"
              className="text-sm text-navy-primary hover:underline font-medium"
            >
              Direito Civil
            </Link>
            ...
            >
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-3">
                  ...
                  <p className="text-gray-secondary leading-relaxed">{service.description}</p>
                </div>

                <div className="space-y-3">
                  <h4 className="font-semibold text-sm text-navy-primary">Serviços inclusos:</h4>
        ...
        <div className="text-center space-y-8 bg-gradient-primary rounded-3xl p-12 text-primary-foreground">
          <div className="space-y-4">
            ...
            <p className="text-lg opacity-90 max-w-2xl mx-auto">
              Agende uma consulta personalizada e descubra como podemos ajudar você a
              resolver sua questão jurídica de forma eficaz.
            </p>
          </div>
